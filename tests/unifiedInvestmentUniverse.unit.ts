...
check('601 unified universe contains both mutual funds', funds.length >= 2 && Boolean(globalFund) && Boolean(emergingFund));
...
console.log(`Unified investment universe: ${passed}/10 invariants passed.`);
