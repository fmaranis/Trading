...
requireText(loader, 'MAX_REALTIME_WINDOW_YEARS = 3', 'MUST_CHUNK_REALTIME_PERIOD_BELOW_FRED_VINTAGE_LIMIT');
requireText(loader, 'buildRealtimeWindows', 'REALTIME_WINDOW_BUILDER_MISSING');
requireText(loader, 'deduped.set(key, row)', 'CHUNK_BOUNDARY_DEDUPLICATION_MISSING');
