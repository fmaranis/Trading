...
check('953 persistent rotation records at least three prior STRONG observations inside the ten-session lookback', (rotatedIncumbent?.rotationChallengerRecentStrongCount ?? 0) >= 3 && rotatedIncumbent?.rotationChallengerPersistenceLookbackSessions === 10);
