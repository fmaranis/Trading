...
interface EvolutionPoint { date: string; valueEur: number; contributedEur: number; cashEur: number; investedEur: number; eventValueEur: number | null; eventLabels: string[]; }
...
async function reconstruct(funds: FundPosition[], holdings: UserHolding[], scan: AssetUniverseScanResult): Promise<EvolutionResult> {
  ...
  let cashEur = 0, contributedEur = 0;
