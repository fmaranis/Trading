...
export const MarketUtilityDashboard: React.FC<Props> = ({ scan, decision, eodhdValidation }) => {
  ...
  return <section className="space-y-4">
    ...
    <section className="rounded-2xl border border-violet-500/20 bg-slate-900 p-5">
      <div className="flex flex-col gap-3 md:flex-row md:items-start md:justify-between">
        <div>
          ...
          <p className="mt-1 text-xs text-slate-400">Solo cambios respecto a snapshots anteriores. La cartera y sus operaciones están arriba; aquí no se repiten órdenes ni asignaciones.</p>
        </div>
    ...
    <details className="rounded-2xl border border-slate-800 bg-slate-900 p-5">
      <summary className="cursor-pointer font-bold">Historial de decisiones</summary>
      <div className="mt-2 text-[11px] text-slate-500">Registro de snapshots para auditoría y detección de cambios; se mantiene plegado para no duplicar la decisión actual.</div>
