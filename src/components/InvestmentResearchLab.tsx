  ...
  return <div className="space-y-5">
    <section className="rounded-2xl border border-violet-500/25 bg-gradient-to-br from-violet-950/35 via-slate-900 to-slate-950 p-5">
      ...
      <div className="mt-4 grid gap-2 md:grid-cols-[1fr_auto]">
        ...
        <div className="rounded-xl border border-slate-700 bg-slate-950 p-3 text-[10px] text-slate-400">También puedes escribir directamente <b className="text-white">AAPL, NVDA, SAN.MC, SAP.DE…</b> en el analizador inferior aunque no estén catalogados.</div>
      </div>
    </section>
    ...
    <section className="rounded-2xl border border-slate-800 bg-slate-900 p-5">
      ...
      <div className="mt-3 text-[10px] text-slate-500">Este ranking compara el universo ya cargado para poder ordenar métricas de forma eficiente. No es un límite del estudio individual. “Más rentable/seguro” describe comportamiento observado, no rentabilidad futura garantizada.</div>
    </section>
