...
- `38b9d4c13959d54a800c7826d2fe2244b71f7946` / `db24d059a848605723a3df2df3e7d5c42cb4c5cb` — transient edit-staging error on `dynamicHistoricalReplay.ts` immediately restored. No intended functional change should be attributed to these commits; verify equivalence before continuing edits.
